...
main:
	movi sp, 0x7FCC		# initialize stack pointer
	movia r2, my_string
...
isr:
	...
	andi  r3, r2, 2			#   (use the proper approach for checking
	beq   r3, r0, next			#    the different interrupt sources)
	
	movia r2, LEDS
	ldwio r3, 0(r2) #load led bits into r3
	xori  r3, r3, 1
	stw   r3, 0(r2) #store at the value of the address of r2
...
#?????:	???	???		# define/reserve storage for program data
	...
	.data
	my_string:   .asciz "ELEC 371 Lab 2\n"
	.end
