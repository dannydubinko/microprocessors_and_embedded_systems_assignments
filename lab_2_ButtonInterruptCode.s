...
#turning on the processor(enable bit) for io devices
	...
	ori   r2, r2, 2	  #or second bit position to make the bit 1
...
isr:
	...
	rdctl r2, ipending			# read ipending
	andi  r3, r2, 2				# check to see if ipending is on but anding
...
TEXT:  .asciz "ELEC 371 Lab 2 by Daniel Dubinko\n"
